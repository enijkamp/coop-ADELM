function [] = experiment_learn_escher_23()

% (23): (18) small batch size, parameter search delta1
%
% result: delta1 = 0.001 good
...
%% params
Deltas1 = [0.1 0.05 0.001, 0.002, 0.004, 0.008];
Gammas1 = [0.07];
Gammas2 = [0.0001];
...
config.T = 10;
config.Delta1 = Delta1; %0.001; % 0.002; % 0.005
config.Gamma1 = Gamma1; % 0.07;
config.refsig1 = 0.016;
config.cap1 = 8;

% parameters for net 2 (generator)
config.Delta2 = 0.3;
config.Gamma2 = Gamma2; %0.0001; % 0.0003;
config.refsig2 = 1;
config.s = 0.3;
config.real_ref = 1;
config.cap2 = 8;
...
lr_51_to_100 = linspace(lr_1_to_50(end), lr_1_to_50(end)/2, 50);

% refinement 2: very slow decay
lr_100_to_400 = linspace(lr_51_to_100(end), 0.00002, 300);
