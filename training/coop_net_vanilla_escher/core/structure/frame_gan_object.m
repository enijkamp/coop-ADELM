...
%num_out = 500;
%filter_sz = 7; 
filter_sz = 5; %for 48x48
%filter_sz = 4; %for 32x32
%upsample = 3; for 64x64
upsample = 4; %for 32x32
%upsample = 3;%for 48x48
crop= [0,0,0,0];
net = add_deconv_block(net, opts, layer_name, filter_sz, filter_sz, num_in, num_out, upsample, crop);
