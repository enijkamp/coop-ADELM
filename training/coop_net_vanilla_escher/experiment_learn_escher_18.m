function [] = experiment_learn_escher_18()

% (18): (17) increase decay to adjust for batch size
%
% result: good - 280 epochs sharp and no collapse
...
config.T = 10;
config.Delta1 = 0.001; % 0.002; % 0.005
config.Gamma1 = 0.07;
