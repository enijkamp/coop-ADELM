function [] = experiment_learn_escher_9()
...
%rate_list = logspace(-2, -5, 80)*100;
%rate_list = logspace(-2, -6, 80)*100;
%rate_list = logspace(-2, -7, 80)*100;
%rate_list = logspace(-2, -8, 80)*100;
rate_list = logspace(-2, -9, 80)*100;
