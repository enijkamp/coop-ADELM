function [] = experiment_learn_escher_21()

% (21): (19) but keep training des
%
% result: ?
...
% (2) refinement: slow decay from (10)
nIteration = 200;
rate_list = logspace(log10(lr_1_to_50(end)), log10(lr_1_to_50(end)/10), 80);
lr_array = repmat(rate_list , max(1,floor(nIteration / length(rate_list))),1);
lr_array = reshape(lr_array, 1, []);
