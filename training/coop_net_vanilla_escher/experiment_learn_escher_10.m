function [] = experiment_learn_escher_10()

% (10): take 60 epochs of (4), then fast decay
...
learningRate_1_to_60 = learningRate_array(1:60);
...
learningRate_array = repmat(rate_list , max(1,floor(nIteration / length(rate_list))),1);
learningRate_array = reshape(learningRate_array, 1, []);
learningRate_61_to_200 = learningRate_array(1:60);

config.learningRate = [learningRate_1_to_60 learningRate_61_to_200];

h = figure; plot(config.learningRate);
