function [] = experiment_learn_escher_25()

% (25): (19) parameter search Delta1
%
% result: Delta1=0.001
...
%% params
Deltas1 = [0.0005 0.001 0.002 0.003 0.004]; % 0.002
Gammas1 = 0.07; %[0.01 0.03 0.05 0.07 0.9 0.14]; % 0.07
Gammas2 = 0.0003; %[0.0003]; % 0.0003
