...
config = frame_config(category,'em',exp_type, 550);
model_file = [config.working_folder, num2str(1, 'layer_%02d'), '_iter_',...
...
%% Step 2 create imdb
[imdb, getBatch, net1] = create_imdb(config, net1, 550);
