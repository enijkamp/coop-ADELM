function [] = experiment_learn_faces_all_1()
...
num_imgs = 97;
exp_type = 'object';
config = frame_config('faces', 'em', exp_type, num_imgs, num2str(exp_id));

%% run
learn_dualNets_config('faces', exp_type, config, num_imgs);
