function [net1,net2,gen_mats,syn_mats] = learn_dual_inn(net1,net2,config,fix_des,fix_gen)
    ...
    for epoch=1:config.nIteration
        [net1_out,net2_out,gen_mats,syn_mats] = process_epoch_inn(opts,epoch,net1,net2,config);     
