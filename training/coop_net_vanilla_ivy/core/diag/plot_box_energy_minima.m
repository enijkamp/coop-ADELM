function plot_box_energy_minima( dirs, out_dir, neg, config, des_net, multi_grid )
...
saveas(f2, [out_dir 'energy_box_good.fig']);
saveas(f2, [out_dir 'energy_box_good.png']);
saveas(f2, [out_dir 'energy_box_good.pdf']);
