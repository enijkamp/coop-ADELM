function [] = experiment_learn_ivy_27()
...
% (27) re-do (24) low gamma2 at the end to solidify results -> good
Deltas1 = [0.15];
Gammas1 = [0.002];
Gammas2 = [0.0002];
Decay1 = [ones(1,150) ones(1,50)];
Decay2 = [ones(1,150) linspace(1,0.01,50)];
...
hrs = floor(exp_time / 3600);
exp_time = mod(exp_time, 3600);
mins = floor(exp_time / 60);
secds = mod(exp_time, 60);
