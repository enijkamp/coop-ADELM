function [] = experiment_learn_ivy_22()
...
% (18) linear decay, epochs=200 -> good, generator could be better
% Deltas1 = [0.15];
% Gammas1 = [0.002];
% Gammas2 = [0.0002];
...
% (22) log decay, epochs=360 -> very good
Deltas1 = [0.15];
Gammas1 = [0.002];
Gammas2 = [0.0002];
Decay1 = logspace(-2, -3, 400)*100;
