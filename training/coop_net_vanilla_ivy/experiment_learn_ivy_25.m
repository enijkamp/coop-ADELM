function [] = experiment_learn_ivy_25()
...
% (24) re-do (17) find minima -> instable minima, but better at epoch 200
% Deltas1 = [0.15];
% Gammas1 = [0.002];
% Gammas2 = [0.0002];
% Decay1 = ones(1,200);
...
% (25) re-do (18) find minima -> instable minima, but much better at epoch 200
Deltas1 = [0.15];
Gammas1 = [0.002];
Gammas2 = [0.0002];
