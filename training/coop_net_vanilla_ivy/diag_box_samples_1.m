...
% plot
out_dir = ['diag/box_samples_' num2str(exp_id) '_1/'];
plot_box_energy(dirs, out_dir, neg, config, net1, false);
...
% plot
out_dir = ['diag/box_samples_' num2str(exp_id) '_2/'];
plot_box_energy(dirs, out_dir, neg, config, net1, false);
...
% plot
out_dir = ['diag/box_samples_' num2str(exp_id) '_3/'];
plot_box_energy(dirs, out_dir, neg, config, net3, true);
...
% plot
out_dir = ['diag/box_samples_' num2str(exp_id) '_4/'];
plot_box_energy(dirs, out_dir, neg, config, net3, true);
