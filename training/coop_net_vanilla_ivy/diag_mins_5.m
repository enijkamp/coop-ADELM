...
if no_workers > 1
    delete(gcp('nocreate'));
    %parpool('comet2', no_workers, 'IdleTimeout', Inf);
...
%% load
exp = 'ivy_dense_em_23_1';
load(['working/' exp '/layer_01_iter_301_model.mat']);
...
% output
config.im_folder = ['minima/ivy_dense_em_23_1_301/'];
