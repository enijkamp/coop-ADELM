function [] = experiment_learn_ivy_3()
...
% vanilla decay, 200 epochs, parameter search
%
% result: Gamma1 > 0.005 explodes
...
nIteration = 200; 
config.learningRate1 = logspace(-2, -4, nIteration)*100;

%% net 2 (generator) decay
nIteration = 200;
config.learningRate2 = logspace(-2, -3, nIteration)*100;
