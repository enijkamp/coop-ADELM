...
net_id = 'ivy_dense_em_11_11';

loaded_nets = load(['working/' net_id '/layer_01_iter_400_model.mat']);
loaded_config = load(['working/' net_id '/config.mat']);
...
% save
if exist(['diag/infer_z_all/' net_id], 'dir')
    rmdir(['diag/infer_z_all/' net_id], 's');
end
mkdir(['diag/infer_z_all/' net_id]);

f1 = figure;
hist(images_min_dist, 40);
saveas(f1, ['diag/infer_z_all/' net_id '/hist.fig']);
saveas(f1, ['diag/infer_z_all/' net_id '/hist.png']);
...
hold off;
saveas(f2, ['diag/infer_z_all/' net_id '/dists.fig']);
saveas(f2, ['diag/infer_z_all/' net_id '/dists.png']);

save(['diag/infer_z_all/' net_id '/images_min_dist.mat'], 'images_min_dist');
save(['diag/infer_z_all/' net_id '/images_min_dist_index.mat'], 'images_min_dist_index');
save(['diag/infer_z_all/' net_id '/images_zs.mat'], 'images_zs');
